<template>
  <view class="uni-container">
    <uni-forms ref="form" :value="formData" validate-trigger="submit" err-show-type="toast">
      ...
      <uni-forms-item name="hobby" label="爱好">
        <uni-data-checkbox mutiple="true" :multiple="true" v-model="formData.hobby" :localdata="formOptions.hobby_localdata"></uni-data-checkbox>
      </uni-forms-item>
      <uni-forms-item name="nation" label="民族" required>
        <uni-data-picker v-model="formData.nation" collection="opendb-nation-china" field="name as text,_id as value"></uni-data-picker>
      </uni-forms-item>
  ...
  export default {
    ...
    methods: {
      ...
      getDetail(id) {
        ...
        db.collection(dbCollectionName).doc(id).field("username,gender,mobile,email,comment,hobby,nation,address").get().then((res) => {
